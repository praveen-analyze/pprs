...
const STATUS_MAP = {
  submitted    : { label: 'Submitted',    bg: 'bg-gray-100',   text: 'text-gray-700',   dot: 'bg-gray-500'   },
...
export default function StatusBadge({ status, size = 'md' }) {
  ...
  return (
    <span className={`inline-flex items-center gap-1.5 font-medium rounded-full ${c.bg} ${c.text} ${size === 'sm' ? 'text-xs px-2 py-0.5' : 'text-sm px-3 py-1'}`}>
